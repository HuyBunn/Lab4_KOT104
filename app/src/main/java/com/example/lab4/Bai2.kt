...
@Composable
fun Bai2(){
    val images = listOf(R.drawable.ic_logo_momo, R.drawable.ic_logo_zalopay,
...
fun PreviewHorizontalImageList() {
    HorizontalImageList(
        listOf(R.drawable.ic_logo_momo, R.drawable.ic_logo_zalopay, R.drawable.ic_logo_paypal)
    )
}
